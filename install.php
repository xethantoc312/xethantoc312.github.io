        ...
        <div>
            <form method="get">
             <input type="text" class="hidden" name="step" value="4" />
                ...
                <span class="padding-small-top">Mã khóa nên dùng các ký tự ngẫu nhiên<a href="http://tools.s2vn.top/password-generator.html" class="text-dot" target="_blank"> Tạo mật khẩu ngẫu nhiên</a></span>
...
<p class="height-small">Cảm ơn bạn đã sử dụng You2PHP - Youtube Download PHP Script. Việt hóa bởi <span style="text-decoration: underline; color: #3366ff;"><a style="color: #3366ff; text-decoration: underline;" href="https://videovn.top">VideoVN.Top</a></span>. Hãy tôn trọng quyền tác giả!</p>
